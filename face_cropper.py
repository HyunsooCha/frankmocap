...
def main(args):
    ...
    path1 = os.path.join(root_path, video_name+'_frames')
    path2 = os.path.join(root_path, video_name+'_cropped_frames')
    output_dir = os.path.join(root_path, video_name+'_mocap_output')
