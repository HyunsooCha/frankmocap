...
then
    ...
    wget https://dl.fbaipublicfiles.com/eft/sampledata_frank.tar && tar -xvf --no-same-owner sampledata_frank.tar && rm sampledata_frank.tar && mv sampledata sample_data
else
