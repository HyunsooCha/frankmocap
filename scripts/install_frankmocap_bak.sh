...
then
    ...
    wget https://dl.fbaipublicfiles.com/eft/sampledata_frank.tar && tar -xvf sampledata_frank.tar --no-same-owner && rm sampledata_frank.tar && mv sampledata sample_data
else
